...
// const faqTitle = document.querySelectorAll('.spollers-block__title');
// const faqBody = document.querySelector('.faq__body');

// for (let i = 0; i < faqTitle.length; i++) {
// 	if (faqTitle[i].classList.contains('_active')) {
// 		faqBody.style.paddingBottom = '5px';
// 		console.log(faqTitle[i]);
// 		break;
// 	} else { faqBody.style.paddingBottom = '190px';
// 	console.log(faqTitle[i]);
// 	}
// }
    ...
    item.addEventListener("click", () => {
        ...
        let checked = document.querySelectorAll(".checked"),
            ...
            if(checked && checked.length > 0){
                ...
                btnText.innerText = "Выберите услугу";
            }
    });
})
